...
def IsGreaterOrEqual(num, max_num):
    """
    IsGreaterOrEqual takes in two numbers and returns true only if the resulting composition of number and
    max_num in order is greater than or equal to the composition of max_num and num
    """
...
def largest_number(lst):
    ...
    :return: string represents the largest (max) composed number that can be arranged out of all given numbers
    """
    answer = ""
